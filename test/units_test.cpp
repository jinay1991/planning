...
TEST_F(UnitManipulators, square_root)
{
    ...
    EXPECT_TRUE(
        (traits::is_convertible_unit<typename std::decay<square_root<square_kilometer>>::type, kilometer>::value));
...
TEST_F(UnitMath, cos)
{
    EXPECT_TRUE((std::is_same<typename std::decay<scalar_t>::type,
                              typename std::decay<decltype(cos(angle::radian_t(0)))>::type>::value));
...
{
    EXPECT_TRUE((std::is_same<typename std::decay<scalar_t>::type,
                              typename std::decay<decltype(sin(angle::radian_t(0)))>::type>::value));
...
{
    EXPECT_TRUE((std::is_same<typename std::decay<scalar_t>::type,
                              typename std::decay<decltype(tan(angle::radian_t(0)))>::type>::value));
...
TEST_F(UnitMath, acos)
{
    ...
    EXPECT_NEAR(angle::degree_t(135).to<double>(),
                angle::degree_t(acos(scalar_t(-0.70710678118654752440084436210485))).to<double>(), 5.0e-12);
}
...
TEST_F(UnitMath, asin)
{
    ...
    EXPECT_NEAR(angle::degree_t(45).to<double>(),
                angle::degree_t(asin(scalar_t(0.70710678118654752440084436210485))).to<double>(), 5.0e-12);
}
...
{
    EXPECT_TRUE((std::is_same<typename std::decay<angle::radian_t>::type,
                              typename std::decay<decltype(atan2(scalar_t(1), scalar_t(1)))>::type>::value));
    EXPECT_NEAR(angle::radian_t(constants::detail::PI_VAL / 4).to<double>(),
                atan2(scalar_t(2), scalar_t(2)).to<double>(), 5.0e-12);
    EXPECT_NEAR(angle::degree_t(45).to<double>(), angle::degree_t(atan2(scalar_t(2), scalar_t(2))).to<double>(),
                5.0e-12);

    EXPECT_TRUE((std::is_same<typename std::decay<angle::radian_t>::type,
                              typename std::decay<decltype(atan2(scalar_t(1), scalar_t(1)))>::type>::value));
    EXPECT_NEAR(angle::radian_t(constants::detail::PI_VAL / 6).to<double>(),
                atan2(scalar_t(1), scalar_t(sqrt(3))).to<double>(), 5.0e-12);
    EXPECT_NEAR(angle::degree_t(30).to<double>(), angle::degree_t(atan2(scalar_t(1), scalar_t(sqrt(3)))).to<double>(),
                5.0e-12);
}
...
{
    EXPECT_TRUE((std::is_same<typename std::decay<scalar_t>::type,
                              typename std::decay<decltype(cosh(angle::radian_t(0)))>::type>::value));
...
{
    EXPECT_TRUE((std::is_same<typename std::decay<scalar_t>::type,
                              typename std::decay<decltype(sinh(angle::radian_t(0)))>::type>::value));
...
{
    EXPECT_TRUE((std::is_same<typename std::decay<scalar_t>::type,
                              typename std::decay<decltype(tanh(angle::radian_t(0)))>::type>::value));
...
{
    EXPECT_TRUE((std::is_same<typename std::decay<angle::radian_t>::type,
                              typename std::decay<decltype(acosh(scalar_t(0)))>::type>::value));
    EXPECT_NEAR(angle::radian_t(1.316957896924817).to<double>(), acosh(scalar_t(2.0)).to<double>(), 5.0e-11);
    EXPECT_NEAR(angle::degree_t(75.456129290216893).to<double>(), angle::degree_t(acosh(scalar_t(2.0))).to<double>(),
                5.0e-12);
}
...
{
    EXPECT_TRUE((std::is_same<typename std::decay<angle::radian_t>::type,
                              typename std::decay<decltype(asinh(scalar_t(0)))>::type>::value));
    EXPECT_NEAR(angle::radian_t(1.443635475178810).to<double>(), asinh(scalar_t(2)).to<double>(), 5.0e-9);
    EXPECT_NEAR(angle::degree_t(82.714219883108939).to<double>(), angle::degree_t(asinh(scalar_t(2))).to<double>(),
                5.0e-12);
}
...
{
    EXPECT_TRUE((std::is_same<typename std::decay<angle::radian_t>::type,
                              typename std::decay<decltype(atanh(scalar_t(0)))>::type>::value));
    EXPECT_NEAR(angle::radian_t(0.549306144334055).to<double>(), atanh(scalar_t(0.5)).to<double>(), 5.0e-9);
    EXPECT_NEAR(angle::degree_t(31.472923730945389).to<double>(), angle::degree_t(atanh(scalar_t(0.5))).to<double>(),
                5.0e-12);
}
...
TEST_F(UnitMath, sqrt)
{
    EXPECT_TRUE((std::is_same<typename std::decay<meter_t>::type,
                              typename std::decay<decltype(sqrt(square_meter_t(4.0)))>::type>::value));
    EXPECT_NEAR(meter_t(2.0).to<double>(), sqrt(square_meter_t(4.0)).to<double>(), 5.0e-9);

    EXPECT_TRUE((std::is_same<typename std::decay<angle::radian_t>::type,
                              typename std::decay<decltype(sqrt(steradian_t(16.0)))>::type>::value));
    ...
    EXPECT_TRUE((std::is_convertible<typename std::decay<foot_t>::type,
                                     typename std::decay<decltype(sqrt(square_foot_t(10.0)))>::type>::value));
...
{
    EXPECT_TRUE((std::is_same<typename std::decay<meter_t>::type,
                              typename std::decay<decltype(hypot(meter_t(3.0), meter_t(4.0)))>::type>::value));
    ...
    EXPECT_TRUE((std::is_same<typename std::decay<foot_t>::type,
                              typename std::decay<decltype(hypot(foot_t(3.0), meter_t(1.2192)))>::type>::value));
...
TEST_F(UnitMath, ceil)
{
    ...
    EXPECT_TRUE((std::is_same<typename std::decay<meter_t>::type,
                              typename std::decay<decltype(ceil(meter_t(val)))>::type>::value));
}
...
TEST_F(UnitMath, fmod) { EXPECT_EQ(fmod(100.0, 101.2), fmod(meter_t(100.0), meter_t(101.2)).to<double>()); }
...
TEST_F(UnitMath, fdim)
{
    ...
    EXPECT_NEAR(meter_t(9.3904).to<double>(), fdim(meter_t(10.0), foot_t(2.0)).to<double>(),
...
TEST_F(CompileTimeArithmetic, unit_value_add)
{
    ...
    EXPECT_TRUE(
        (std::is_same<typename std::decay<foot_t>::type, typename std::decay<decltype(sumf::value())>::type>::value));
    ...
    EXPECT_TRUE((
        std::is_same<typename std::decay<celsius_t>::type, typename std::decay<decltype(sumc::value())>::type>::value));
...
TEST_F(CompileTimeArithmetic, unit_value_subtract)
{
    ...
    EXPECT_TRUE(
        (std::is_same<typename std::decay<foot_t>::type, typename std::decay<decltype(difff::value())>::type>::value));
    ...
    EXPECT_TRUE((std::is_same<typename std::decay<celsius_t>::type,
...
TEST_F(CompileTimeArithmetic, unit_value_multiply)
{
    ...
    EXPECT_TRUE((std::is_same<typename std::decay<square_meter_t>::type,
    ...
    EXPECT_TRUE((std::is_same<typename std::decay<square_foot_t>::type,
    ...
    EXPECT_FALSE((std::is_same<typename std::decay<torque::newton_meter_t>::type,
                               typename std::decay<decltype(productN::value())>::type>::value));
    EXPECT_TRUE((std::is_convertible<typename std::decay<torque::newton_meter_t>::type,
                                     typename std::decay<decltype(productN::value())>::type>::value));
    ...
    EXPECT_TRUE((std::is_same<typename std::decay<steradian_t>::type,
...
TEST_F(CompileTimeArithmetic, unit_value_divide)
{
    ...
    EXPECT_TRUE((std::is_same<typename std::decay<meters_per_second_t>::type,
    ...
    EXPECT_TRUE((std::is_same<typename std::decay<radians_per_second_t>::type,
...
TEST_F(CompileTimeArithmetic, unit_value_power)
{
    ...
    EXPECT_TRUE((std::is_convertible<typename std::decay<square_meter_t>::type,
    ...
    EXPECT_TRUE((std::is_convertible<typename std::decay<steradian_t>::type,
...
TEST_F(CompileTimeArithmetic, unit_value_sqrt)
{
    ...
    EXPECT_TRUE((std::is_convertible<typename std::decay<meter_t>::type,
    ...
    EXPECT_TRUE((std::is_convertible<typename std::decay<mile_t>::type,
