...
*/
#ifndef PLANNING_PATH_PLANNING_ASTART_2_H
#define PLANNING_PATH_PLANNING_ASTART_2_H
...
struct hash<GridLocation>
{
    ...
    std::size_t operator()(const GridLocation& id) const noexcept { return std::hash<int>()(id.x ^ (id.y << 4)); }
};
}  // namespace std
...
GridWithWeights make_diagram4()
{
    ...
    grid.forests = std::unordered_set<GridLocation>{L{3, 4}, L{3, 5}, L{4, 1}, L{4, 2}, L{4, 3}, L{4, 4}, L{4, 5},
...
#endif  /// PLANNING_PATH_PLANNING_ASTART_2_H
