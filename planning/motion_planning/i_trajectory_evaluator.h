...
///
#ifndef PLANNING_MOTION_PLANNING_I_TRAJECTORY_EVALUATOR_H
#define PLANNING_MOTION_PLANNING_I_TRAJECTORY_EVALUATOR_H
...
#endif  /// PLANNING_MOTION_PLANNING_I_TRAJECTORY_EVALUATOR_H
